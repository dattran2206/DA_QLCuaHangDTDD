...
namespace GUI
{
    public partial class DanhMucPhieuThuChi : Form
    {
        ...
        public void LoadDataPT()
        {
            try
            {
                gv_thu.DataSource = pt.LayPhieuThu();
        ...
        private void DanhMucPhieuThuChi_Load(object sender, EventArgs e)
        {
            LoadDataPT();
            LoadDataPC();
        }
        ...
        private void dateTimePicker1_ValueChanged(object sender, EventArgs e)
        {
            ...
            {
                gv_thu.DataSource = tk.TKphieuthu(DateTime.Parse(dateTimePicker1.Text), DateTime.Parse(dtpNgayden.Text));
